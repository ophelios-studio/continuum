...
{
    public function add(int $caseId, string $address, string $role, ?int $orgId = null, bool $accepted = true): int
    {
    ...
    public function changeRole(int $caseId, string $address, string $role): void
    {
        $this->query(
    ...
    public function remove(int $caseId, string $address): void
    {
        $this->query(
    ...
    public function isParticipant(int $caseId, string $address): bool
    {
    ...
    public function roleOf(int $caseId, string $address): ?string
    {
        $row = $this->selectSingle(
